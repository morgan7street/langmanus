...
REASONING_API_KEY = os.getenv("REASONING_API_KEY", "your-openrouter-api-key")
...
BASIC_API_KEY = os.getenv("BASIC_API_KEY", "your-openrouter-api-key")
...
VL_API_KEY = os.getenv("VL_API_KEY", "your-openrouter-api-key")
